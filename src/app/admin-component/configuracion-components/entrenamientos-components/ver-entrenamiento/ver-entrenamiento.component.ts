...
@Component({
  ...
  templateUrl: './ver-entrenamiento.component.html',
  styleUrls: ['./ver-entrenamiento.component.scss']
})
export class VerEntrenamientoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<VerEntrenamientoComponent>,
