...
@Component({
  selector: 'app-fecha-personalizada',
  templateUrl: './fecha-personalizada.component.html',
  styleUrls: ['./fecha-personalizada.component.scss']
})
export class FechaPersonalizadaComponent implements OnInit {
  min: any;


  constructor(
    public dialogRef: MatDialogRef<FechaPersonalizadaComponent>,
     ...
     if(resp.ok){
      ...
      this.dialogRef.close(true);
       ...
       if(resp.err.code == 100){
        this.err(this.translate.instant('user.home.choose.personalized.limit.title'),this.translate.instant('user.home.choose.personalized.limit.subtitle'))
       }else{
        this.err(this.translate.instant('user.home.choose.personalized.error.title'),this.translate.instant('user.home.choose.personalized.error.subtitle'))
       }
