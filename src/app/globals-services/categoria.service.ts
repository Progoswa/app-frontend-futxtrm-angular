...
export class CategoriaService {
  ...
  getCategoriasPerUser(id) {
    return this.http.get(`${environment.URL_API}/categoria/count/${id}`);
  }
  ...
  editarCategoria(id, body) {
    return this.http.put(
      `${environment.URL_API}/categoria/categoria/${id}`,
      body
    );
  }
  eliminarCategoria(id, usuario) {
    return this.http.delete(
      `${environment.URL_API}/categoria/categoria/${id}/${usuario}`
    );
  }
  ...
  getMyCategorias(id) {
    return this.http.get(
      `${environment.URL_API}/categoria/miscategorias/${id}`
    );
  }

  getMyCategoriasInfo(id) {
    return this.http.get(
      `${environment.URL_API}/categoria/categoriasinfo/${id}`
    );
  }

  categoriaOwner(body) {
    return this.http.post(
      `${environment.URL_API}/categoria/categoriaowner`,
      body
    );
  }
